...
public class RPG_Game {
    ...
    public static void startGame() {
        Warrior warrior = new Warrior(290, 20, "Mainer");
        Medic doc = new Medic(240, 5, 20, "Aibolit");
        Magic magic = new Magic(270, 15, "Harry");
        Berserk berserk = new Berserk(200, 10, "Berserk");
        Medic assistant = new Medic(280, 10, 5, "Doc");
        Thor thor = new Thor(250, 15, "Thor");
        Golem golem = new Golem(300, 5, "Stone");
        Witcher witcher = new Witcher(260, 0, "Witcher");
